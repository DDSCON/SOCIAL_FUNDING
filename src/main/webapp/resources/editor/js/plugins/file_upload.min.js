    ...
    a.Editable.commands = a.extend(a.Editable.commands, {
        ...
        b.$file_wrapper.on("dragover", "#f-file-upload-div-" + this._id, function() {
            ...
            if (0 === a(".froala-element img.fr-image-move").length && c.originalEvent.dataTransfer && d && d.length) {
                ...
                b.options.allowedImageTypes.indexOf(d[0].type.replace(/image\//g, "")) < 0 && (b.closeImageMode(), b.hide(), b.imageMode = !1, b.initialized || (b.$element.unbind("mousedown.element"), b.lateInit()), b.insertMarkersAtPoint(c.originalEvent), b.showByCoordinates(c.originalEvent.pageX, c.originalEvent.pageY), b.uploadFile(d), c.preventDefault(), c.stopPropagation())
            }
        })
        ...
        this.$file_wrapper.on("change", 'input[type="file"]', function() {
            ...
            a.stopPropagation(), a.preventDefault(), this.$bttn_wrapper.show(), this.hideFileWrapper(), this.restoreSelection(), this.focus(), this.hide()
